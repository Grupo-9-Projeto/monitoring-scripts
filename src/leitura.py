...
def metricas():
    ...
    return[media_cpu_1h, media_ram_1h, pico_cpu_1h, cpu_maior,  download_hora, upload_hora]



print(f" MEDIA CPU 1 HORA: {metricas()[0]:.2f} \n MEDIA RAM 1 HORA: {metricas()[1]:.2f} \n PICO CPU 1 HORA: {metricas()[2]} \n CPU MAIOR: {metricas()[3]} \n DOWNLOAD HORA: {metricas()[4]:.2f} \n UPLOAD HORA: {metricas()[5]}")
